                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <div class="d-flex flex-row align-items-center">
                        <div>
                          <img src="../uploads/{{$product->image}}" class="img-fluid rounded-3" alt="Shopping item" style="width: 80px;">
                        </div>
                        <div style="width: 380px;" class="ms-3">
                          <h5 style="font-size: 16px;">{{$product->name}}</h5>
                        </div>
                      </div>
                      <div class="d-flex flex-row align-items-center">
                        ...
                        <a href="cart/{{$product->id}}" style="color: #cecece; margin-left: 15px;"><i class="fa-solid fa-trash"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
